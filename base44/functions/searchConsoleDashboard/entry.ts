...
const ALL_PAGES = [
  "/",
  "/services", "/portfolio", "/about", "/contact", "/contactform",
  "/quoteassistant", "/protips", "/schedulevisit",
  "/smallbathroomideas", "/luxuryhomerenovations",
  "/landingcoreservices", "/landingemergencyrepair", "/landingbrandonremodelers",
  "/landingpricing", "/landingtrust",
  "/renovationloans", "/homeadditionideas", "/energyefficientupgrades",
  "/legal", "/jobsites",
  "/projects/historic-home-restoration",
  "/custom-home-builder-brandon-ms", "/barndominium-builder", "/barndominiums-ms",
  "/remodeling-ms", "/quote", "/customertestimonials",
  "/home-remodeling-cost", "/finish-package-studio",
];
  ...
  try {
    ...
    if (action === "getCrawlErrors") {
      const LANDING_PAGES = [
        ...
        "/renovationloans", "/homeadditionideas", "/energyefficientupgrades",
        "/protips", "/contactform",
        "/jobsites", "/barndominiums-ms", "/barndominium-builder",
        "/remodeling-ms", "/quote", "/customertestimonials",
        "/home-remodeling-cost", "/finish-package-studio",
        "/custom-home-builder-brandon-ms", "/projects/historic-home-restoration",
      ];
