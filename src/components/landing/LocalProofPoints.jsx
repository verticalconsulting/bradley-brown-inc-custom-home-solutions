...
const defaultProof = [
  { icon: Award, text: "Licensed MS General Contractor since 2005 — 20+ years serving Brandon and the Rankin County area" },
  { icon: MapPin, text: "Locally owned & operated in Brandon, MS — serving a 50-mile radius including Jackson, Madison & Rankin County" },
  { icon: Star, text: "5.0★ rating — trusted by Mississippi families" },
];
