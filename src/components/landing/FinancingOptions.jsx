  ...
  return (
    <div>
      ...
      <div className="mt-8 flex flex-col sm:flex-row gap-4">
        ...
        <Link
          to={"/estimate"}
          className="inline-flex items-center gap-2 border border-sky-200 text-sky-700 px-6 py-3 rounded-lg font-semibold hover:bg-sky-50 transition-colors bg-[hsl(var(--background))]">Get a Free Estimate
