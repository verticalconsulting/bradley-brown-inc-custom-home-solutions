  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <a href="tel:+16012345678" className="flex-1 inline-flex items-center justify-center gap-2 bg-[#C4922A] text-white px-5 py-3 rounded-lg font-semibold hover:bg-[#A37820] transition-colors">
