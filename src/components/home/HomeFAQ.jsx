...
export const homeFaqs = [
  {
    ...
    answer: (
      <>
        ...
        <Link to="/pricing" className="text-sky-600 hover:underline font-medium">
          pricing page
        </Link>{" "}
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        or visit our{" "}
        <Link to="/services/emergency-repairs" className="text-sky-600 hover:underline font-medium">
          emergency repairs
        </Link>{" "}
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        , or read our{" "}
        <Link to="/protips/renovation-loans" className="text-sky-600 hover:underline font-medium">
