    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center pt-20">
        ...
        <div className="hidden sm:flex flex-row gap-4 justify-center">
          <Link
            to={createPageUrl("QuoteAssistant")} className="hover:bg-[#A37820] text-white px-8 py-4 text-lg font-semibold rounded-xl inline-flex items-center justify-center gap-2 transition-all hover:scale-105 shadow-lg bg-lime-700">
