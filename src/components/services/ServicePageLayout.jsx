      ...
      <section className="bg-[#1E2D3D] py-14 md:py-20 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
            <Link to="/estimate" className="inline-flex items-center justify-center gap-2 hover:bg-[#A37820] text-white px-8 py-4 rounded-full font-bold text-base transition-colors shadow-lg bg-[hsl(var(--chart-5))]">Get My Free Estimate
